...
db_name = 'test'
engine = create_engine(f'postgresql://{pg_user}:{pg_pass}@{host}:5432/{db_name}', echo=True)
...
if __name__ == '__main__':
    engine.execute('CREATE TABLE employee( id int not null, name varchar(40) not null);')
